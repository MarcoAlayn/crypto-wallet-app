...
- Ordenamiento de assets: Los assets se pueden ordenar por nombre o precio, haciendo clic en el encabezado correspondiente.
- Seleccionar como favorito: Se puede marcar un asset como favorito haciendo clic en el corazón que se encuentra en cada fila.
- Agrupar assets favoritos: Se pueden agrupar los assets favoritos, haciendo clic en la opción "Mostrar solo favoritos" en la barra de navegación.
...
- Si no hay búsqueda por nombre, se verifica si se deben mostrar los favoritos y se renderizan estos.
- Si no se deben mostrar los favoritos, se verifica si existen activos ordenados y se renderizan estos.
- Si no existen activos ordenados, se renderizan todos los activos disponibles.
...
- Se importan las acciones resetSearchBar y searchByName desde "../../redux/actions".
...
- Se importa showFavorites y resetSearchBar de "../../redux/actions"
...
- El componente renderiza un grupo de botones de radio de Bootstrap, con dos opciones: "Show All" y "Show Favorites". Al elegir una opción, se activa o desactiva un botón y se invoca la acción correspondiente para mostrar todos o solo los favoritos, y resetear la barra de búsqueda.

## Acciones

### fetchAssets()

- Realiza una solicitud a la API de Coinstats para obtener información sobre los activos.
